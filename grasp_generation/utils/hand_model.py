    ...
    def __init__(self, urdf_path, contact_points_path, n_surface_points=0, device='cpu'):
        ...
        for link in self.robot.links:
            ...
            if type(collision.geometry) == Sphere:
                ...
                print(os.path.join(os.path.dirname(urdf_path), 'meshes', link.name+".STL"))
                link_mesh = tm.load_mesh(os.path.join(os.path.dirname(urdf_path), 'meshes', link.name+".STL"), process=False)
        ...
        for link_name in self.mesh:
            ...
            # if link_name == "right_hand_thumb_rota_link2":
            #     for ii in range(surface_points.shape[0]):
            #         pp = surface_points[ii,:]
            #         # print(pp)
            #         if pp[2] < -0.005 and pp[1]<0.011 and pp[1]>-0.011:
            #             print(pp)
        ...
        # self.adjacency_mask[self.link_name_to_link_index['right_hand_link'], self.link_name_to_link_index['link_13.0']] = True
